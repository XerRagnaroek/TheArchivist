...
/**
 * Edited version of JDA's InterfacedEventManager, making it send all exceptions to the dev. I would
 * have just extended it but listeners is private s
 */
public class InterfacedEvendManager implements IEventManager {
	private final CopyOnWriteArrayList<EventListener> listeners = new CopyOnWriteArrayList<>();

	public InterfacedEvendManager() {
